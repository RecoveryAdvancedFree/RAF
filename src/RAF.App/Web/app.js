...
const SectorMapView = (() => {
  ...
  const LEGENDS = {
    scan: { 2: 'נסרק', 3: 'נמצאו קבצים', 1: 'תפוס — דולג', 5: 'פגום', 0: 'טרם נסרק' },
    hunt: { 2: 'נבדק', 3: 'נמצאה מחיצה', 5: 'פגום', 0: 'טרם נבדק' },
    image: { 2: 'הועתק', 4: 'ממתין לניסיון חוזר', 5: 'פגום', 0: 'טרם הועתק' },
  };
