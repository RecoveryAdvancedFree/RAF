...
public sealed class PartitionInfo
{
    ...
    /// <summary>
    /// המחיצה לא רשומה בשום טבלה: בתמונה שאין בה טבלת מחיצות ומערכת קבצים מזוהה,
    /// התוכנה מניחה שכל הקובץ הוא מחיצה אחת — כדי שאפשר יהיה לאבחן ולסרוק אותו.
    /// זו הנחה בלבד, ולכן היא לא מסתירה מחיצות שסריקת הכונן מוצאת בתוכה.
    /// </summary>
    public bool Assumed { get; init; }
}
