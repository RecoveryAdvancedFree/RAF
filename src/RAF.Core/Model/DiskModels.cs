        ...
        return disk.Media switch
        {
            ...
            MediaKind.UsbFlash or MediaKind.MemoryCard => new RecoveryProfile
            {
                ...
                Rationale = disk.Media == MediaKind.MemoryCard
                    ? "כרטיס זיכרון: רוב הכרטיסים אינם תומכים ב-TRIM, ולכן נתונים שנמחקו " +
                      "נשארים על ההתקן. הסריקה תתבצע ברצף בבלוקים של 512KB בהתאם למהירות הכרטיס."
                    : "התקן USB נייד: רוב ההתקנים אינם תומכים ב-TRIM, ולכן נתונים שנמחקו " +
                      "נשארים על ההתקן. הסריקה תתבצע ברצף בבלוקים של 512KB.",
            },
