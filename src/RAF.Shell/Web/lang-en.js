...
Object.assign(EN, {
  ...
  'נמצאה גם טבלת הקבצים של המחיצה': "The partition's file table was found too",
  'מגזר האתחול שלה אבד, אבל רשומות הקבצים שרדו. סריקה שלה מחזירה את הקבצים עם השמות והתיקיות המקוריים — גם קבצים מפוצלים.':
    'Its boot sector was lost, but the file records survived. Scanning it brings back the files with their original names and folders — fragmented files too.',
  'סריקה עם שמות ותיקיות': 'Scan with names and folders',
